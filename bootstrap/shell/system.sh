...
alias pf.start='pf start'
alias pf.stop='pf stop'
alias pf.status='pf status'
alias pf.update='pf update'
alias pf.revert='pf revert'
alias pf.uninstall='pf revert'
alias pf.logs='pf logs'
alias pf.log.start='pf logs start'
alias pf.log.stop='pf logs stop'
alias pf.log.status='pf logs status'
alias pf.log.path='pf logs path'
alias pf.log.clear='pf logs clear'
alias pf.apply='pf update'
alias pf.install='pf start'
alias pf.remove='pf revert'
alias pf.dns='pfd'
alias pf.blocks='pf blocks'
