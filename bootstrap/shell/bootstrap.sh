...
# dev-cmd: alias=pz name="Publish Zsh Link (pz)" group=sys run=user desc="Link tracked zsh config into home and reload current shell"
pz() {
...
# dev-cmd: alias=pzcp name="Publish Zsh Copy (pzcp)" group=sys run=user desc="Copy tracked zsh config into home and reload current shell"
pzcp() {
