...
- `inventory.sh`: summary, legend, validate, manifest, status-dashboard wrappers, and discovered script alias publication
...
- `devtools.sh`: dev-only helpers such as `devzip` and editor shortcuts
